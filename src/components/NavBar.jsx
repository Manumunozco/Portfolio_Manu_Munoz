...
<div className="min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
  <CustomMobileLink href="/dummy.pdf" target={"_blank"} title="Curriculum Vitae" className="mr-10" toggle={handleClick} />
  <CustomMobileLink href="mailto:munozc.manuel@gmail.com" title="Contact" toggle={handleClick} />
</div>
  : null
}
