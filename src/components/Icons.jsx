...
export const InstagramIcon = ({ className, ...rest }) => (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M11.997 2C6.47 2 2 6.478 2 12.005v.14c0 5.527 4.47 10.009 9.997 10.009.094 0 .188-.002.282-.007.1.006.2.007.3.007s.2-.002.3-.007c.094.005.188.007.282.007 5.527 0 9.997-4.48 9.997-10.009v-.14C22 6.478 17.53 2 11.997 2zm.293 2h.004c3.445 0 6.237 2.792 6.237 6.208v.12c0 1.732-.56 3.315-1.51 4.607-.08.1-.177.202-.284.294-.442.396-.977.67-1.543.872a7.3 7.3 0 0 1-1.32.29c-.333.05-.667.08-1.01.08s-.677-.03-1.01-.08a7.3 7.3 0 0 1-1.32-.29c-.566-.202-1.1-.476-1.542-.872-.107-.092-.204-.194-.283-.294-.952-1.292-1.512-2.875-1.512-4.607v-.12c0-3.416 2.792-6.208 6.237-6.208zM12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16zm0 2a6 6 0 1 1 0 12 6 6 0 0 1 0-12zm6.3-.39a1 1 0 1 1-1.4 1.42 1 1 0 0 1 1.4-1.42z"
      />
    </svg>
  );
  ...
  export const FacebookIcon = ({ className, ...rest }) => (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M14 2v2h-2c-2.21 0-4 1.79-4 4v2H5v3h3v7h4v-7h3l1-3h-4V8a1 1 0 0 1 1-1h3V4h-3a1 1 0 0 0-1 1v1h-2V5a3 3 0 0 1 3-3h2z"
      />
    </svg>
  );
  
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#25D366" width="100px" height="100px">
  <path d="M12 0C5.373 0 0 5.373 0 12c0 5.808 4.474 10.562 10.188 11.176v2.718l3.192-1.666c.836.23 1.716.354 2.62.354 6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22.849c-1.352 0-2.666-.223-3.893-.633l-.41-.125-2.484 1.295.664-2.414-.154-.428c-.723-2.007-1.102-4.096-1.102-6.174 0-2.173.405-4.305 1.19-6.276L7.147 1.37l2.327-.606C10.973.52 11.475.273 12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12z"/>
</svg>
