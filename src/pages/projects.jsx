...
<Link href={link} target="_blank" className="w-full cursor-pointer overflow-hidden rounded-lg">
    <Image src={img} alt={title} className="w-full h-auto object-cover m-5 p-5" />
</Link>
...
<h2 className="my-2 w-full text-left text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl font-bold">{title}</h2>
</a>
...
<AnimatedText text="My Projects" className="mt-16 mb-16 text-4xl sm:!text-5xl lg:!text-6xl xl:!text-7xl" />
